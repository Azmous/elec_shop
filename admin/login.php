    ...
    <div class="logo"><a href="#"><img src="images/logo.gif" alt="" title="" border="0" /></a></div>
            ...
            <?php 
                if(isset($_POST['submit'])){
                    ...
                    $dangnhap = $M_khachhang->admin($user,$pass);
                    if($dangnhap==true){
                        $_SESSION['user_name']= $dangnhap->taikhoan;
         ...
         <form action="" method="post" class="niceform">
                ...
                <fieldset>
                    <dl>
                        ...
                        <dd><input type="text" name="user" size="54" /></dd>
                    </dl>
                    <dl>
                        <dt><label for="password">Password:</label></dt>
                        <dd><input type="text" name="pass"  size="54" /></dd>
                    </dl>
